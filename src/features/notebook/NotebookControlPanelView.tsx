...
import {appProfile, visitorZones} from '../../domain/berlinGuide';
import {useNavigation} from '../../app/navigation/NavigationContext';
import {colors} from '../../shared/theme';
import {openWebsite} from '../../shared/native/deviceActions';

export function NotebookControlPanelView(): React.JSX.Element {
  ...
  return (
    <Screen>
      ...
      <View style={styles.row}>
        ...
        <Button title="Activity" variant="secondary" onPress={() => navigation.push('VisitTimeline')} style={styles.rowButton} />
      </View>
