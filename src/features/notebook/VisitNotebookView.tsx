...
import {checklistItems, venues} from '../../domain/berlinGuide';
import {useNavigation} from '../../app/navigation/NavigationContext';
import {colors} from '../../shared/theme';

export function VisitNotebookView(): React.JSX.Element {
    ...
    <Screen withBottomNav>
      ...
      <Card style={styles.cardHeader} accent>
        ...
        <View style={styles.row}>
          <Button title="Route Card" onPress={() => navigation.push('RoutePocketCard')} style={styles.rowButton} />
          <Button title="Settings" variant="secondary" onPress={() => navigation.push('NotebookControlPanel')} style={styles.rowButton} />
        </View>
      </Card>
      ...
      <Card style={styles.section}>
        <View style={styles.sectionTop}>
          ...
          <Pressable onPress={() => navigation.push('PrivateNoteEditor')}>
      ...
      <Button title="Add Private Note" onPress={() => navigation.push('PrivateNoteEditor')} />
    </Screen>
  );
}
