...
import {appProfile, assets, checklistItems, gameGuides, toolkitItems, venues} from '../../domain/berlinGuide';
import {useNavigation} from '../../app/navigation/NavigationContext';
import {colors} from '../../shared/theme';
import {getRegularVenueStatus} from '../../domain/berlinGuide';

export function BerlinGuestHubView(): React.JSX.Element {
    ...
    <Screen withBottomNav>
      ...
      <ImageBackground source={assets.hubHero} style={styles.hero} imageStyle={styles.heroImage}>
        ...
        <View style={styles.heroGrid}>
          ...
          <Pressable onPress={() => navigation.push('ArrivalPlanner')} style={styles.heroLink}>
      ...
      <Card style={styles.facts} accent>
        ...
        <Button title="First Visit Guide" onPress={() => navigation.push('EntryPrimer')} />
      </Card>
      ...
      <View style={styles.gameRow}>
        {gameGuides.slice(0, 3).map(game => (
          <Pressable
            ...
            onPress={() => navigation.push('GameBriefing', {gameId: game.id})}>
            <AppText variant="caption" style={styles.area}>
              {game.category}
            </AppText>
            <AppText style={styles.bold} numberOfLines={2}>
