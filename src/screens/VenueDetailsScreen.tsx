...
import {appProfile, venues} from '../data/content';
import {useNavigation} from '../navigation/NavigationContext';
import {colors} from '../theme';
import {openDirections, openPhone, openWebsite} from '../utils/deviceActions';
...
export function VenueDetailsScreen({venueId}: Props): React.JSX.Element {
      ...
      <View style={styles.content}>
        ...
        <View style={styles.actions}>
          <Button
            ...
            style={styles.action}
          />
          <Button title="Route Card" variant="secondary" onPress={() => navigation.push('RouteCard', {venueId: venue.id})} style={styles.action} />
        </View>
        <View style={styles.actions}>
